...
const Service = () => {
  ...
  return (
    <>
        <div className='text-[#FFD700] text-xs sm:text-2xl md:text-4xl font-imprint text-center py-8' >Service</div>
    ...
    <div className='grid grid-cols-2 gap-x-12 gap-y-8'>
        {serviceArr.map((item) => (
            <div key={item.service}>
                ...
                <div className='text-center text-[#FFD700] py-2 font-imprint text-lg'>{item.service}</div>
            </div>
        ))}
