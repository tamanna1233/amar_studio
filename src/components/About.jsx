...
const About = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center  py-4 px-8'>
     <div className='text-[#FFD700] text-lg sm:text-2xl md:text-4xl font-imprint'>About us</div> 
     ...
     <img src={logo} alt=""  className='min-w-2/5 sm:w-2/5 h-auto ' loading='lazy'/>
     ...
     <div className=' sm:flex justify-center items-center px-4 gap-x-20'>
     <img src={drone} alt=""  className='w-full sm:w-2/5 flex sm:hidden  ' loading='lazy'/>

        <p className='text-white  font-poppin text-[0.64rem] sm:text-sm 5/6 sm:w-2/6  '>Our expertise goes beyond traditional photography with advanced drone services, adding a unique perspective to your special day. We combine creativity, technology, and an eye for detail to deliver exceptional quality in every shot.         </p>
     <img src={drone} alt=""  className='w-full sm:w-2/5  hidden sm:flex  h-auto'/>
     </div>
